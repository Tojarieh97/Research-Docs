...
MUB have been proposed as a tool for quantum key distribution (QKD). In QKD,
a key is shared between two parties in a secure way~\cite{bennett_quantum_1984}, and MUB can be used to encrypt the key in such a way that any
third party trying to intercept it will not be able to read it.
MUB can be used to encrypt the key in a way that relative to other sets of states, it is more secure against any type of attacks~\cite{wootters1989optimal}.
